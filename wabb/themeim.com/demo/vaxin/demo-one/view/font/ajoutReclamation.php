...
if (isset($_POST['nom']) and isset($_POST['mail']) and isset($_POST['sujet']) and isset($_POST['message']) ){



$reclamation1=new reclamation($_POST['nom'],$_POST['mail'],$_POST['sujet'],$_POST['message']);
